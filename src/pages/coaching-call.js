  ...
  <Layout>
    ...
    <LightContainer>
      <SectionContent>
        ...
        <p>
          Picture this: stepping off the treadmill. Working smarter, not harder.
          Seeing persistent issues fade away. Gaining the confidence to take
          decisive actions that improve your team's performance.
        </p>
        <hr />
        <h3 className="align-center">
