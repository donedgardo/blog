...
function HeroSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Portrait fade and slide in
      gsap.from(".hero-portrait-container", {
        opacity: 0,
        x: 50,
        duration: 1,
        delay: 0.3,
    ...
    <section id="hero" ref={heroRef}>
      <div className="container">
        <div className="row flex-md-nowrap">
          <div className="col-1 col-12 col-md-7 col-lg-8" ref={textRef}>
          ...
          <div className="col-2 col-12 col-md-6 hero-portrait-container" ref={portraitRef}>
            <Portrait
            ...
            <div className="hero-testimonial d-flex flex-wrap flex-md-nowrap" ref={testimonialRef}>
...
function ChallengesSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".challenges-title", {
        scrollTrigger: {
          trigger: ".challenges-title",
          start: "top 85%",
      ...
      // Pain points list items stagger
      gsap.from("#challenges ul li", {
        scrollTrigger: {
          trigger: "#challenges ul",
          start: "top 80%",
          toggleActions: "play none none none",
        },
        opacity: 0,
      ...
      // Bottom message
      gsap.from(".challenges-bottom", {
        scrollTrigger: {
          trigger: ".challenges-bottom",
          start: "top 85%",
          toggleActions: "play none none none",
        },
        opacity: 0,
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 col-md-6">
            <h2 className="roboto-light text-center sec-title challenges-title">
              Sound{" "}
        ...
        <div className="row justify-content-center challenges-bottom">
...
function OffersSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Services cards - slide in from left and right
      gsap.from(".service:nth-child(1)", {
        scrollTrigger: {
          trigger: ".services",
          start: "top 75%",
          toggleActions: "play none none none",
  ...
  return (
    <section id="offers" ref={sectionRef}>
      <div className="container">
        <div className="row justify-content-center offers-header">
          <div className="col-12 col-md-11 px-2 px-md-4">
            ...
            <h3 className="roboto-light text-white text-center">
              ...
              <strong>ship fast and safe</strong>.
            </h3>
          </div>
        </div>
        ...
        <div className="row services flex-md-nowrap justify-content-center">
          <div className="service col-12 col-md-5">
            <div className="inner">
              <img
                className="img-fluid"
            ...
            <p className="testimonial-message text-white">
              <small>
                <em>
                  ...
                  grow technically and enforcing high code standards through 
                  TDD and tool integration."
                </em>
              </small>
            </p>
        ...
        <div className="row">
          <div className="col col-12 col-md-4">
            <div className="inner">
              ...
              <p>
                <strong>CTOs and Engineering Leaders</strong> tired of 
          ...
          <div className="col col-12 col-md-4">
            <div className="inner">
              ...
              <p>
                <strong>SaaS teams</strong> scaling past their current 
                release process
              </p>
            </div>
          </div>
          ...
          <div className="col col-12 col-md-4">
            <div className="inner">
              ...
              <p>
                <strong>Organizations</strong> who need senior DevSecOps 
...
function ShortCutSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Header animation
      gsap.from(".shortcut-header", {
        scrollTrigger: {
          trigger: ".shortcut-header",
          start: "top 85%",
          toggleActions: "play none none none",
        },
        opacity: 0,
      ...
      // After items - slide from right
      gsap.from(".items-2 li", {
        scrollTrigger: {
          trigger: ".items-2",
          start: "top 80%",
          toggleActions: "play none none none",
  ...
  return (
    <section id="shortCut" ref={sectionRef}>
      <div className="container">
        <div className="row justify-content-center shortcut-header">
            ...
            <ul className="items">
              <li>
                <div className="content">
                  <strong>Manual deployments</strong> everyone's afraid to 
                  touch
                </div>
                <svg
                  width="49"
              ...
              <li>
                <div className="content">
                  <strong>Security as an afterthought</strong> caught too late
                </div>
                <svg
                  width="49"
                  height="21"
              ...
              <li>
                <div className="content">
                  <strong>Releases that break things</strong> and burn out 
                  the team
                </div>
                <svg
                  width="49"
              ...
              <li>
                <div className="content">
                  <strong>Slow feedback loops</strong> that hide problems
                </div>
                <svg
                  width="49"
                  height="21"
          ...
          <div className="col-2 col-12 col-md-6">
            ...
            <ul className="items-2">
              ...
              <li>
                ...
                <div className="content">
                  <strong>Security checks that run automatically</strong>{" "}
                  on every commit
                </div>
              </li>
              ...
              <li>
                ...
                <div className="content">
                  <strong>Rapid, reliable releases</strong> that ship 
                  without drama
                </div>
              </li>
              ...
              <li>
                ...
                <div className="content">
                  <strong>Tight feedback loops</strong> that catch issues 
                  before production
                </div>
              </li>
            </ul>
...
function TransformationSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Header animation
      gsap.from(".transformation-header", {
        scrollTrigger: {
      ...
      // Metrics boxes stagger in
      gsap.from(".trans-boxes .col-12", {
        scrollTrigger: {
          trigger: ".trans-boxes",
          start: "top 80%",
          toggleActions: "play none none none",
      ...
      // Counter animations
      const metrics = [
        { selector: ".counter-1", value: 80 },
        { selector: ".counter-2", value: 250 },
        { selector: ".counter-3", value: 300 },
        { selector: ".counter-4", value: 50 },
      ]
  ...
  return (
    <section id="transformation" ref={sectionRef}>
      <div className="container">
        <div className="row justify-content-center transformation-header">
          <div className="col-12 col-md-8">
        ...
        <div className="row trans-boxes">
          <div className="col-12 col-md-3 text-center">
            <div className="inner">
              ...
              <h1 className="color-primary">
                <span className="counter-1">80</span><span>%</span>
              </h1>
              <p>Lead Times</p>
            </div>
          </div>
          <div className="col-12 col-md-3 text-center">
            <div className="inner">
              ...
              <h1 className="color-primary">
                <span className="counter-2">250</span><span>%</span>
              </h1>
              <p>Throughput</p>
            </div>
          </div>
          <div className="col-12 col-md-3 text-center">
            <div className="inner">
              <small>Increased by</small>
              <h1 className="color-primary">
                <span className="counter-3">300</span><span>%</span>
              </h1>
          ...
          <div className="col-12 col-md-3 text-center">
            <div className="inner">
              <small>Decreased by</small>
              <h1 className="color-primary">
                <span className="counter-4">50</span><span>%</span>
              </h1>
      ...
      <div className="container">
        <div className="row align-items-center justify-content-end">
          <img
            ...
            alt=""
          />
          <div className="col-2 col-12 col-md-6 about-content">
...
function BottomCTASection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.from("#bottom-cta .container > *", {
        scrollTrigger: {
          trigger: "#bottom-cta",
          start: "top 80%",
          toggleActions: "play none none none",
  ...
  return (
    <section id="bottom-cta" ref={sectionRef}>
      <div className="container">
