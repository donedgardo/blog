              ...
              <div className="service col-12 col-md-4">
                <div className="inner">
                  ...
                  <div className="text-container text-white">
                    <h4 className="service-title">SaaS Team Bootcamp</h4>
                    <p>
                      Dive into a free, comprehensive Six-Part Email Series
                ...
                <div className="inner">
                  ...
                  <div className="text-container text-white">
                    <h4 className="service-title">
                      SaaS Team Performance Roadmap
                    </h4>
                    <p>
                      Unlock your team's true potential with a personalized
                      strategy plan. This in-depth assessment includes a
                      thorough codebase review and team interviews, resulting in
                      a 10+ page roadmap from an industry expert for unmatched
                      performance.
                    </p>
                  </div>
                </div>
